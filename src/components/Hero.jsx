        ...
        >
          ...
          <div className="relative h-full flex flex-col justify-center px-10 md:px-20 z-10">
            <motion.div
              ...
              className="inline-block bg-primary text-primary-content px-4 py-1 font-bold uppercase tracking-widest mb-6 rounded-sm"
            >
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-black text-white max-w-3xl leading-[1.1] mb-4 uppercase"
            >
            ...
            >
              ...
              <button className="border-2 border-white/30 text-white px-10 py-4 font-black uppercase hover:border-white transition-all rounded-md backdrop-blur-md">
                Browse Catalog
              </button>
            </motion.div>
          </div>
