...
export default function Footer() {
  return (
    <footer className="flex flex-col lg:flex-row lg:justify-between footer footer-center p-6 md:p-10 md:px-40 bg-base-200 text-base-content rounded-none mt-20">
