                ...
                <div className="md:w-1/2 p-8 md:p-12 flex items-center justify-center">
                    <div>
                        ...
                        <button
                            ...
                            className="w-full font-bold bg-black text-white border-2 border-black py-3 flex items-center justify-center gap-3 hover:bg-zinc-800 transition-colors mb-6"
                        >
